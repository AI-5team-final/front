...
const PanelPosting = () => {
  ...
  return (
    <main className="l-panel l-panel-postings">
        ...
        <div className="inner">
          <div className="hero-text">
            ...
            <p className="subtitle">
              채용공고를 한눈에 관리하고, 더 나은 인재 채용을 준비하세요.
            </p>
          </div>
          <img
      ...
      <section className="section section-upload">
        <div className="inner">
          ...
          <div className="register-wrap">
            <div className="date-area">
              <div>
                ...
                <h4>공고기간 설정</h4>
                <p>
                  공고의 시작일과 마감일을 선택해주세요.
                  <br />
                  선택한 기간 동안만 지원자가 공고를 확인할 수 있습니다.
                </p>
                  ...
                  {fileState.name ? (
                    ...
                    <>
                      ...
                      <p className="upload-paragraph">
                        PDF 파일로 채용공고를 등록해보세요.{" "}
                      </p>
                      <p className="upload-paragraph">
                        공고는 등록 후 언제든 삭제할 수 있어요.
                      </p>
                      <p className="upload-note">
                        *PDF 형식만 업로드 가능하며, 이미지 파일은 인식되지
                        않습니다.
                      </p>
                    </>
                  )}
          ...
          <div className="btn-wrap">
            <button
              type="button"
              className={`btn-reset ${selectedOne() ? "" : "disabled"}`}
              onClick={handleReset}
            >
              <IoMdRefresh /> 초기화
            </button>
            <button
              type="button"
              className={`btn-register ${allSelected() ? "" : "disabled"}`}
      ...
      <section className="section section-list">
        <div className="inner">
          ...
          <div className="list">
            {isLoading ? (
              <div
                style={{ padding: "20px 0", borderBottom: "1px solid #e0e0e0" }}
              >
                <LoadingSpinner />
                <div className="loading">공고 목록을 불러오는 중...</div>
              </div>
      ...
      {/* 공고 업로드 확인 모달 */}
      <UploadCheckPostingModal
        isOpen={isModalOpen}
        onRequestClose={closeUploadModal}
        fileState={fileState}
        handleSubmit={handleConfirmUpload}
        startDate={startDate}
        endDate={endDate}
      />
