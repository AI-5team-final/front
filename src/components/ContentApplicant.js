  ...
  const handleLoadConfirm = async () => {
    ...
    if (selectedResume) {
      try {
        ...
        const file = new File([blob], selectedResume.pdfFileName, {
      ...
      {isLoadModalOpen && (
        <div className="modal-backdrop">
          <div className="modal">
              ...
              resumes.map((resume) => (
                <div
                  ...
                  className={`resume-list-item ${
                    selectedId === resume.id ? "selected-resume-item" : ""
                  }`}
                  onClick={() =>
                    setSelectedId((prev) =>
            ...
            <div className="modal-buttons">
              <button className="modal-button" onClick={handleLoadConfirm}>
                선택하기
              </button>
              <button
        ...
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <div className="modal-subtitle">
              AI agent "Fit Advisor"는 당신이 가고 싶은 회사에 맞는 로드맵을
              만들어줘요
            </div>
            <div className="divider" />
